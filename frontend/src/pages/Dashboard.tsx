        ...
        {hasProjectsAccess && (
          <div className="rounded-xl border border-amber-500/30 bg-gradient-to-br from-amber-500/10 to-amber-600/5 p-6 hover:border-amber-500/50 transition-all min-w-0 overflow-hidden">
            <div className="flex items-center justify-between mb-2 gap-2 min-w-0">
              <h3 className="text-sm text-amber-300/80 font-medium shrink-0">Valor Total</h3>
            ...
            <p className="text-2xl md:text-3xl font-bold text-amber-100 break-words" title={projects.reduce((acc, project) => acc + (project.valorTotal ?? 0), 0).toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' })}>
